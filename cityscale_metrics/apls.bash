...
# source directory
dir=$1
data_dir='/home/work/data/RoadGraph/cityscale'
mkdir -p "${dir}/save/apls"
echo $dir
# now loop through the above array
for i in "${arr[@]}"
do
    if test -f "${dir}/save/graph/${i}.p"; then
        echo "========================$i======================"
        ...
        cd apls
        go run main.go "${dir}/save/gt.json" "${dir}/save/prop.json" "${dir}/save/apls/${i}.txt"
        cd ..
